...
@ViewScoped
@Model
public class InformeMarcaBean implements Serializable {
    ...
    private List<SelectItem> UsuarioSelectItemList;
    private Date initDate;
    private Date endDate;

    @PostConstruct
    public void init() {
        UsuarioSelectItemList = new ArrayList<SelectItem>();
        List<Usuario> usuarioList = usuarioManager.getAll();
        for (Usuario usuario : usuarioList) {
            UsuarioSelectItemList.add(new SelectItem(usuario.getId(), usuario.getPresona().toString()));
        }

        marcaLaboralList = marcaLaboralManager.getAll();
    }

    public void genInforme() throws Exception {
    ...
    public List<SelectItem> getUsuarioSelectItemList() {
        return UsuarioSelectItemList;
    }

    public void setUsuarioSelectItemList(List<SelectItem> UsuarioSelectItemList) {
        this.UsuarioSelectItemList = UsuarioSelectItemList;
    }
